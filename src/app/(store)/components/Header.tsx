...
const Header = () => {
  ...
  return (
    <header className="w-full">
      ...
      {/* Mobile Menu */}
      {isOpen && (
  <nav className="z-20 absolute w-full bg-white shadow-lg p-4 md:hidden animate-slide-in">
    <ul className="flex flex-col gap-4">
      ...
      <li className="relative">
        ...
        <ul className="mt-2 pl-4 space-y-2">
          <li>
            <Link href="/pages/contact" className="hover:text-[#029FAE] hover:font-bold">
              Contact Us
            </Link>
          </li>
          <li>
            <Link href="/pages/faq" className="hover:text-[#029FAE] hover:font-bold">
              FAQ
            </Link>
          </li>
        </ul>
