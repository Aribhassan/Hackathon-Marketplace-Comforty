...
const Hero = () => {
  return (
    <motion.div
      ...
      className="flex flex-col justify-self-center items-center w-screen md:w-[80%] max-w-[1740px] overflow-hidden"
    >
      {/* Content Container */}
      <div className="bg-[#F0F2F3] flex flex-col justify-center items-center md:flex-row px-10 py-6">
        {/* Left Section */}
        ...
        <motion.div
          ...
          className="md:w-1/2 flex justify-center items-center mt-10 md:mt-0 py-12"
        >
          <Image
            src={Product1}
            alt="Furniture Chair"
      ...
      {/* Logos Section with Slide Effect */}
      <motion.div
        className="flex flex-wrap justify-center md:justify-between items-center w-full max-w-[1740px] mt-8 gap-y-2 gap-x-6 px-4"
        initial={{ x: "100%" }}
        animate={{ x: 0 }}
