    ...
    <footer className="bg-white text-black border">
      ...
      <div className="flex flex-col items-center justify-center px-4 py-16">
        <div className="w-[80%] flex flex-col sm:flex-wrap md:flex-nowrap md:flex-row justify-center text-center md:text-start items-center md:items-start gap-4">
          ...
          <div className="flex flex-col space-y-2 md:w-[40%] mb-6 animate-slide-left">
          ...
          {/* Categories */}
          <div className="flex flex-col space-y-2 w-[25%] mb-6 animate-slide-left delay-200">
          ...
          {/* Support */}
          <div className="w-1/3 mb-6 animate-slide-left delay-400">
          ...
          {/* Newsletter */}
          <div className="w-2/3 mb-6 animate-slide-left delay-600">
            <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">
              NEWSLETTER
            </h2>
      ...
      <div className="w-full py-4">
        <div className="w-full max-w-[80%] flex flex-col mx-auto">
          <p className="text-gray-500 text-sm">
            © 2025 Comforty - Designed & Developed by Syed Arib Hassan
          </p>
        </div>
      </div>
    </footer>
